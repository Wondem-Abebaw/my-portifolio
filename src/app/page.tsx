...
export default function Home() {
  ...
  return (
    <div className="bg-[#111827] text-[#FFFFFF] min-h-screen">
      <Navbar />
      ...
      >
        <div className="flex-1">
          <p className="text-[#6366F1] text-xs tracking-[0.2em] uppercase font-medium mb-5">
            Senior Frontend Developer
          </p>
          <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.05] tracking-tight mb-6">
            Wondem
            <br />
            <span className="text-[#6366F1]">Abebaw</span>
          </h1>
          <p className="text-[#9CA3AF] text-lg leading-relaxed max-w-xl mb-10 font-light">
          ...
          <div className="flex flex-wrap gap-4">
            {/* <a
              ...
              target="_blank"
              className="inline-flex items-center gap-2 px-7 py-3 bg-[#6366F1] text-[#111827] font-bold text-sm tracking-wide hover:bg-[#4F46E5] transition-colors"
            >
            ...
            <a
              href="#projects"
              className="inline-flex items-center gap-2 px-7 py-3 border border-[#6366F1] text-[#6366F1] font-bold text-sm tracking-wide hover:bg-[#6366F1] hover:text-[#111827] transition-colors"
            >
              View Work
          ...
          {/* Stats */}
          <div className="flex flex-wrap gap-10 mt-14 pt-10 border-t border-[#374151]">
            {stats.map(({ num, label }) => (
              <div key={label}>
                <div className="text-3xl font-extrabold text-[#6366F1]">{num}</div>
                <div className="text-xs text-[#9CA3AF] tracking-wider mt-1">{label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex-shrink-0">
          <div className="relative">
            <div className="absolute inset-[-3px] rounded-full bg-gradient-to-br from-[#6366F1] to-transparent" />
            <img
              src="/profile.png"
              alt="Wondem Abebaw"
              className="w-48 h-48 rounded-full object-cover relative border-4 border-[#111827]"
            />
          </div>
        </div>
      </section>
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 md:px-20 py-20">
        ...
        <div className="w-12 h-[3px] bg-[#6366F1] mb-10" />
      ...
      {/* ── Projects ── */}
      <section id="projects" className="bg-[#1F2937] py-20">
